...
public class BlogController {
    ...
    @PostMapping
    public Result saveBlog(@RequestBody Blog blog) throws BaseException {
    ...
    @GetMapping("/{id}")
    public Result queryBlogById(@PathVariable Long id) throws BaseException {
    ...
    public Result queryBlogOfFollow(@RequestParam("lastId") Long max,
        ...
        ScrollResult blogs = blogService.querBlogOfFollw(max,offset);
